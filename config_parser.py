...
def get_args_parser():
    ...
    parser.add_argument("--model_name_or_path", default='roberta-large', type=str,
                        help="pre-trained language model")
    parser.add_argument("--dataset_type", default="rams",choices=["ace_eeqa", "rams", "wikievent", 'MLEE', 'flickr30k', 'flickr30k_furn','flickr30k_Animals',
                                                                  'flickr30k_Archlnfra','flickr30k_ArtDecor','flickr30k_ClothingAcc','flickr30k_ElecEntertain'
                                                                  , 'flickr30k_Food', 'flickr30k_Misc', 'flickr30k_Nature', 'flickr30k_People', 'flickr30k_SignComm'
                                                                  , 'flickr30k_Sport', 'flickr30k_TransVeh', 'flickr30k_test_food'], type=str,
    ...
    parser.add_argument("--max_enc_seq_length", default=256, type=int,
    ...
    parser.add_argument('--num_prompt_pos', default=10, type=int)
    ...
    parser.add_argument("--max_dec_seq_length", default=200, type=int,
